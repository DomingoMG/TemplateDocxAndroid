...
public class Main extends AppCompatActivity
{
    ...
    public static void pruebadetexto(String rutaPlantilla, String extension, boolean convertirPdf) throws IOException, XDocReportException
    {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnGenerar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                try
                {
                    pruebadetexto("file:///android_asset/test.docx", "docx", false);
                }catch (Exception e)
                {
